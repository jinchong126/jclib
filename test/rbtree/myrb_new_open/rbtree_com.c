...
int container_insert_new(struct rbtree_container_head *sta_rbtree, struct rbtree_container *sta_node)
{
	int result = 0;
	...
	while(*new)
	{
		...
		result = sta_rbtree->compare_rbtree_struct_cb(rbtree_new->rbtree_data, this->rbtree_data);
